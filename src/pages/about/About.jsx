...
// import PremiumFooter from "../../components/PremiumFooter"; // adjust path if needed
        ...
        <section className="relative h-[70vh] lg:h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6">
            <motion.span
              ...
              className="text-xs tracking-[0.4em] uppercase text-white/80 mb-6 block">
              Since 1847
            </motion.span>
            ...
            <motion.h1
              ...
              className="font-serif text-5xl md:text-6xl lg:text-7xl text-white mb-6 leading-[1.1] text-balance">
              Our Heritage
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-white/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
              Five generations of Italian craftsmanship, dedicated to the pursuit of timeless
              elegance.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-32 px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <motion.p
              ...
              In the heart of Florence, where the Renaissance redefined beauty and craftsmanship,
              our story began. What started as a modest workshop has evolved into a symbol of
              Italian excellence, yet our founding principles remain unchanged: exceptional
              materials, masterful technique, and an unwavering commitment to perfection.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-32 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <motion.div
              ...
              <span className="text-xs tracking-[0.4em] uppercase text-muted-foreground mb-4 block">
                Our Journey
              </span>
              ...
              {timeline.map((item, index) => (
                <motion.div
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? "lg:text-right" : "lg:text-left"}`}>
                    ...
                    <p className="text-gray-foreground leading-relaxed text-sm lg:text-base">
                      {item.description}
                    </p>
                  </div>
        ...
        <section className="py-20 lg:py-32 bg-foreground text-background">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center mb-16 lg:mb-24">
              <span className="text-xs tracking-[0.4em] uppercase text-background/60 mb-4 block">
                The Artisans
              </span>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <motion.blockquote
              ...
              <p className="font-serif text-2xl lg:text-4xl leading-relaxed mb-8 text-balance">
                "True luxury is not about ostentation. It is about the quiet confidence that comes
                from knowing every detail has been considered, every stitch placed with intention."
              </p>
